...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            <button class="btn-hover bg-blue-500 text-white px-6 py-3 rounded-lg font-medium mb-8">
                Add Service
            </button>
                ...
                <table class="w-full">
                    ...
                    <tbody class="text-gray-700">
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            <td class="py-4 px-4">Shirt</td>
                            <td class="py-4 px-4">Wash</td>
                            <td class="py-4 px-4">৳150</td>
                            <td class="py-4 px-4">
                                <button type="button" class="text-blue-500 hover:text-blue-700 mr-3" aria-label="Edit">
                                ...
                                <button type="button" class="text-red-500 hover:text-red-700" aria-label="Delete">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            <td class="py-4 px-4">Pant</td>
                            <td class="py-4 px-4">Iron</td>
                            <td class="py-4 px-4">৳100</td>
                            <td class="py-4 px-4">
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            <td class="py-4 px-4">Jacket</td>
                            <td class="py-4 px-4">Dry Clean</td>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="text-gray-700">
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            <td class="py-4 px-4">Dhaka City</td>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            <td class="py-4 px-4">Chittagong</td>
                            <td class="py-4 px-4">৳100</td>
                            <td class="py-4 px-4">
                                <button class="text-blue-500 hover:text-blue-700 mr-3">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            <td class="py-4 px-4">Khulna</td>
                            <td class="py-4 px-4">৳80</td>
                            <td class="py-4 px-4">
                                <button class="text-blue-500 hover:text-blue-700 mr-3">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path
