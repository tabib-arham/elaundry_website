...
<head>
    ...
    <link rel="stylesheet" href="style/resister.css">
</head>
    ...
    <div class="main-content">
        <div class="register-container">
            ...
            <div class="header">
                ...
                <p class="subtitle">Want Service!</p>
            ...
            <form class="form" id="registrationForm" method="POST" action="">
                ...
                <div class="login-link-section">
                    Already have an Account? <a href="log.html" class="login-link">Login</a>
                </div>
                ...
                <div class="email-notice">
                    <p>*Please check your mail for further procedures.</p>
                    <p>If mail not found, send us a message.</p>
                </div>
            </form>
        </div>
    </div>
